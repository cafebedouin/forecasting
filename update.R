...
fred(code="WPU091301",
     ...
     bins=c(128.371, 130.2775, 132.184, 134.0905, Inf),
...
fred(code="TRUCKD11",
     ...
     bins=c(120, Inf),
     probability_type="monte-threshold") 
...
# West Texas Crude
source("fred.R")
fred(code="DCOILWTICO",
     begin_date="2000-01-01", # For analysis, not question
     closing_date="2021-12-30",
     bins=c(30, 45, 60, 75, 90, Inf),
     probability_type="monte") 
...
# Update Wheat
source("fred.R")
fred(code="PWHEAMTUSDM",
     begin_date="2000-01-01", # For analysis, not question
     closing_date="2021-11-01",
     bins=c(220, 260, 300,340, Inf),
     probability_type="monte",
     title=paste0(code, " Wheat "),
     subtitle="",
     info_source="FRED",
     file_name="FRED",
     graph_width=1250,
...
fred(code="SP500",
     begin_date="2010-01-01", # For analysis, not question
     closing_date="2022-06-30", 
     bins=c(3800, 4100, 4400, 4700, 5000, Inf),
     probability_type="monte",
